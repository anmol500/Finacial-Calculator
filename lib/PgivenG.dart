...
class PgivenG extends StatelessWidget {
  @override
...
formula(double p, double i, double n) {
  var k = pow(1 + (i / 100), n) - (i / 100) * n - 1;
  var h = pow((i / 100), 2) * (pow(1 + (i / 100), n));

  return [
    roundDouble((p * (k / h)), 3).toString(),
    roundDouble((k / h), 3).toString()
  ];
}
